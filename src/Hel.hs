...
helSchema
    ...
    $ SemaphoreCons (SemaphoreRight ll lr :: Semaphore "B" (Link _ 53) (Link _ 54))
    $ SemaphoreCons (SemaphoreLeft lr ll :: Semaphore "C" (Link _ 52) (Link _ 51))
    $ SemaphoreCons (SemaphoreLeft lr ll :: Semaphore "D" (Link _ 50) (Link _ 49))
    $ SemaphoreCons (SemaphoreLeft lr ll :: Semaphore "E" (Link _ 48) (Link _ 47))
    $ SemaphoreCons (SemaphoreLeft lr ll :: Semaphore "F" (Link _ 46) (Link _ 45))
    $ SemaphoreCons (SemaphoreRight ll lr :: Semaphore "A" (Link _ 43) (Link _ 44))
